...
const book_params_1 = require("./book-params");
let BookResolver = class BookResolver {
    ...
    async deleteBook(_id) {
        const deletedBook = await book_entity_1.BookModel.findByIdAndRemove(_id);
        return deletedBook;
    }
    async editBook(_id, data) {
        return book_entity_1.BookModel.findByIdAndUpdate(_id, data, { new: true });
    }
};
__decorate([
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [book_params_1.CreateBookInput]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, book_params_1.EditBookInput]),
    __metadata("design:returntype", Promise)
